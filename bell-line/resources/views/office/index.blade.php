        ...
        <li>
          <a href="{{ route('office.search') }}"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
              ...
              stroke-linejoin="round" class="lucide lucide-binoculars-icon lucide-binoculars mr-2 text-blue-700">
              <path d="M10 10h4" />
      ...
      <ul class="space-y-3">
        ...
        <li>
          <a href="{{ route('office.invoices') }}"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
              fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
              stroke-linejoin="round" class="lucide lucide-printer-icon lucide-printer mr-2 text-orange-400">
