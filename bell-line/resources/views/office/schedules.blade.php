<x-for_admin-layout>
  ...
  <section class="max-w-8xl mx-auto bg-white p-10">
    ...
    <div class="flex justify-end">
      <a href="{{ route('office.schedules_create') }}"><button type="button"
        ...
        <tbody>
          <tr>
            <th class="px-4 py-8  border flex justify-between text-gray-400">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="40" height="20" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <td class="p-4 text-center border-b-3 border-amber-400">1197</span>
            </td>
            <td class="w-lg p-2 text-center border-r-3 border-b-3 border-amber-400">スタバ空カート</td>

            <td class="p-4 text-center border-b-3 border-indigo-400">1197
            </td>
            <td class="w-lg p-2 text-center border-r-3 border-b-3 border-indigo-400">スタバ空カート</td>

            <td class="p-4 text-center border-b-3 border-pink-700">MFJ
            </td>
          ...
          <tr>
            ...
            <td class="p-4 border border-gray-500 text-center">954<span class="block text-xs mt-2">12:00</span></td>
            ...
            <td class="p-4 text-center border-b-3 border-amber-400">松本
            </td>
            <td class="w-lg p-2 text-center border-r-3 border-b-3 border-amber-400">緑13:00～東扇島×2（土曜休み）36000
            </td>

            <td class="p-4 text-center border-b-3 border-indigo-400">ロジテム</span>
            </td>
            <td class="w-lg p-2 text-center border-r-3 border-b-3 border-indigo-400">流山21:50~相模原28000　1:30</td>
          ...
          <tr>
            ...
            <td class="w-lg p-2 text-center border-r-3 border-b-3 border-red-500">松本</td>
            <td class="p-4 text-center border-b-3 border-amber-400">OS1
            </td>
            <td class="w-lg p-2 text-center border-r-3 border-b-3 border-amber-400">松本
            </td>

            <td class="p-4 text-center border-b-3 border-indigo-400">OS1</span>
            </td>
            <td class="w-lg p-2 text-center border-r-3 border-b-3 border-indigo-400">松本</td>

            <td class="w-lg p-2 text-center border-b-3 border-pink-700">MFJ</td>
