<x-for_admin-layout>
    ...
    <div class="flex justify-center gap-10">
      <table class="w-full border-collapse bg-white text-left text-sm text-gray-500 space-y-3">
        <tbody class="divide-y divide-gray-100 border-t border-gray-100">
          <tr>
            <th class="h6 border-1 font-medium bg-gray-50 text-center w-2/6">前月の給与等の金額</th>
            <td class="h6 px-4 border-1"><input type="number" id="days"
          ...
          <tr>
            <th class="h6 border-1 font-medium bg-gray-50 text-center w-2/6">賞与に乗ずべき率</th>
            <td class="h6 px-4 border-1"><input type="number" id="days"
                class="w-full rounded-md border-gray-300 p-3 shadow-sm focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50">
            </td>
          </tr>
          <tr>
            <th class="border-0 size-dvw"></th>
            <td></td>
          </tr>
        </tbody>
      </table>
      <table class="w-full border-collapse bg-white text-left text-sm space-y-3">
        ...
        <tbody class="divide-y divide-gray-100 border-t border-gray-100">
          <tr>
            <th class="border-1 font-medium bg-gray-50 text-center w-2/6">賞与額</th>
            <td class="px-4 border-1"><input type="number" id="bonus"
                class="w-full rounded-md border-gray-300 p-3 shadow-sm focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50">
            </td>
          </tr>
          <tr>
      ...
      <table class="w-full border-collapse text-sm">
        ...
        <tbody class="divide-y divide-gray-100 border-t border-gray-100">
          <tr>
            <th class="border-l-1 border-r-1 font-medium bg-gray-50 text-center">健康保険</th>
            <td class="px-4 border-1"><input type="number" id="health"
                class="w-full rounded-md border-gray-300 p-3 shadow-sm focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50">
            </td>
          </tr>
          <tr>
            <th class="border-l-1  font-medium bg-gray-50 text-right">（基本）</th>
            <td class="px-4 border-1"><input type="number" id="health-basic"
                class="w-full rounded-md border-gray-300 p-3 shadow-sm focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50">
            </td>
          </tr>
          <tr>
            <th class="border-l-1  font-medium bg-gray-50 text-right">（特定）</th>
            <td class="px-4 border-1"><input type="number" id="health-identification"
                class="w-full rounded-md border-gray-300 p-3 shadow-sm focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50">
            </td>
          </tr>
          <tr>
            <th class="border-1 font-medium bg-gray-50 text-center">介護保険</th>
            <td class="px-4 border-1"><input type="number" id="nursing-care"
                class="w-full rounded-md border-gray-300 p-3 shadow-sm focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50">
            </td>
          </tr>
          <tr>
            <th class="border-1 font-medium bg-gray-50 text-center">厚生年金</th>
            <td class="px-4 border-1"><input type="number" id="welfare-pension"
                class="w-full rounded-md border-gray-300 p-3 shadow-sm focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50">
            </td>
          </tr>
          <tr>
            <th class="border-1 font-medium bg-gray-50 text-center">年金基金</th>
            <td class="px-4 border-1"><input type="number" id="pension-fund"
                class="w-full rounded-md border-gray-300 p-3 shadow-sm focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50">
            </td>
          </tr>
          <tr>
            <th class="border-1 font-medium bg-gray-50 text-center">雇用保険</th>
            <td class="px-4 border-1"><input type="number" id="employment-insurance"
                class="w-full rounded-md border-gray-300 p-3 shadow-sm focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50">
            </td>
          </tr>
          <tr>
            <th class="border-1 font-medium bg-gray-50 text-center">所得税</th>
            <td class="px-4 border-1"><input type="number" id="income-tax"
                class="w-full rounded-md border-gray-300 p-3 shadow-sm focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50">
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <th class="border-1 font-medium bg-gray-50 text-center">年末調整</th>
            <td class="px-4 border-1"><input type="number" id="year-adjustment"
                class="w-full rounded-md border-gray-300 p-3 shadow-sm focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50">
            </td>
          </tr>
          <tr>
            <th class="border-1 font-medium bg-gray-50 text-center">調整額</th>
            <td class="px-4 border-1"><input type="number" id="adjustment-amount"
                class="w-full rounded-md border-gray-300 p-3 shadow-sm focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50">
            </td>
          </tr>
        </tbody>
  ...
  <section class="max-w-7xl mx-auto bg-white p-10">
    <table class="w-4/6 border-collapse bg-white text-left text-sm">
      ...
      <tbody class="divide-y divide-gray-100 border-t border-gray-100">
        <tr>
          <th class="border-1 font-medium bg-gray-50 text-center">差引支給額</th>
          <td class="px-4 border-1"><input type="number" id="deduction"
              class="w-full rounded-md border-gray-300 p-3 shadow-sm focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50">
          </td>
        </tr>
        <tr>
          <th class="border-1 font-medium bg-gray-50 text-center">銀行振込１</th>
          <td class="px-4 border-1"><input type="number" id="bank1"
              class="w-full rounded-md border-gray-300 p-3 shadow-sm focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50">
          </td>
        </tr>
        <tr>
          <th class="border-1 font-medium bg-gray-50 text-center">銀行振込２</th>
          <td class="px-4 border-1"><input type="number" id="bank2"
              class="w-full rounded-md border-gray-300 p-3 shadow-sm focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50">
          </td>
        </tr>
        <tr>
          <th class="border-1 font-medium bg-gray-50 text-center">現金</th>
          <td class="px-4 border-1"><input type="number" id="cash"
              class="w-full rounded-md border-gray-300 p-3 shadow-sm focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50">
          </td>
        </tr>
      </tbody>
